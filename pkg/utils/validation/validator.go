...
// customValidation maps validation tags to corresponding validation functions.
var customValidation = map[string]func(fl validator.FieldLevel) bool{
	"phonenumber": ValidPhoneNumber,
}

func (v *Validator) registerCustomValidation() error {
	for tag, fn := range customValidation {
